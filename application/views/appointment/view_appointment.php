                                        ...
                                        <?php if ($this->session->userdata('route_path') == 'users/doctor') { ?>
                                            ...
                                            <td>
                                                <?php if ($this->uri->segment(3)) { ?>
                                                    <a href="<?php echo base_url() . 'patient/add_diagnosis/' . $appointment->ap_id. '/' . $this->uri->segment(3); ?>" ><i class="fa fa-plus-circle" aria-hidden="true" title="Add Diagnosis"></i></a>
                                                <?php } else { ?>
