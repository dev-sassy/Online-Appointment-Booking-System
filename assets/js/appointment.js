$(document).ready(function () {
    ...
    $("#book_app_form").validate({
        ...
        messages: {
            dr_list: {
                required: "Please select doctor from drop down",
            },
            app_date: {
                required: "Please select the appointment date",
            },
            p_list: {
                required: "Please select patient from drop down",
            },
            app_time: {
                required: "Please select time from drop down"
            },
        }
    });
});
...
function chk_for_appointment()
{
    ...
    if (dr_id && app_date)
    {
        ...
        $.ajax({
            url: "../appointment/chk_available_appointment",
            type: "POST",
